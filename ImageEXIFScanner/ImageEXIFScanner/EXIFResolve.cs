...
{
    public static class EXIFResolve
    {
        public static string ConvertToString(this byte[] bytes) =>
            System.Text.Encoding.Default.GetString(bytes);
        public static string ResolveEXIF(this int id)
        {
            string ret = "Unknown";
            if (EXIFResolver.ContainsKey(id))
                ret = EXIFResolver[id];
            return ret;

        }
        public static readonly Dictionary<int, string> EXIFResolver = new Dictionary<int, string>(){{0x0000,"GpsVer"},
